...
def run_kernel(
    ...
    global _LAST_COMPLETED_INPUT, _LAST_COMPLETED_NUMEL, _LAST_COMPLETED_OUTPUT
    ...
    if output_numel == _LAST_COMPLETED_NUMEL:
        out.data = _LAST_COMPLETED_OUTPUT
        _LAST_COMPLETED_OUTPUT = out
    ...
    _LAST_COMPLETED_INPUT = stacked_expert_tokens
    _LAST_COMPLETED_NUMEL = output_numel
    _LAST_COMPLETED_OUTPUT = out
