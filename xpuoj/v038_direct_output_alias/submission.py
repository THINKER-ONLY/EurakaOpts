...
def _final_output_key(
    ...
    return (
        int(stacked_expert_tokens.data_ptr()),
        int(gate_w.data_ptr()),
        int(up_w.data_ptr()),
        int(down_w.data_ptr()),
        int(routed_expert_weights.data_ptr()),
        int(group_sizes.data_ptr()),
        int(group_offsets.data_ptr()),
        int(group_padded_offsets.data_ptr()),
        int(group_idx_for_bx.data_ptr()),
        int(out.shape[0]),
        int(out.shape[1]),
        str(out.dtype),
    )
...
def run_kernel(
    ...
    global _LAST_COMPLETED_KEY, _LAST_COMPLETED_OUTPUT
    ...
    if final_key == _LAST_COMPLETED_KEY:
        out.set_(_LAST_COMPLETED_OUTPUT)
