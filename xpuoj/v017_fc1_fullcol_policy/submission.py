        ...
        with T.Kernel(compute_blocks_m, T.ceildiv(intermediate, fc1_block_n), threads=threads) as (bx, by):
            ...
            if actual_rows > 0:
                ...
                for k in T.Pipelined(
                    ...
                    T.gemm(input_shared, gate_shared, gate_local, transpose_B=True, policy=T.GemmWarpPolicy.FullCol)
                    T.copy(
                        up_w[
                            expert_id,
                            by * fc1_block_n : (by + 1) * fc1_block_n,
                    ...
                    T.gemm(input_shared, up_shared, up_local, transpose_B=True, policy=T.GemmWarpPolicy.FullCol)
