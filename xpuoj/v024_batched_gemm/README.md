...
Submission `#64212` was accepted with **88.67 points**:
...
| case2 | 3.762 ms | 89 |
| case3 | 7.938 ms | 87 |
| total | 13.778 ms | **88.67** |

This improves the accepted v023 total from 28.390 ms by **51.47%** and raises
the score from 72.67 to 88.67.
