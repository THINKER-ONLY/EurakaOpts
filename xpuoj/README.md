...
- 当前 XPUOJ 最佳版本仍为 `v008_fc2_bk64`，61.33 分，43 ms；v012、
  v013 和 v014 线上同为 61.33 分，均未取得可见提升（本次未提供总耗时）。
...
| [v014_sparse_bm16_tier](v014_sparse_bm16_tier/README.md) | 61.33 | 未提供（本地 -23.78%） | 超稀疏 wide-hidden shape 继续缩小到 BM16 | 线上中性，本地拒绝 |
...
为准，本地 C500 后续实验从 v013 派生，并继续保持“一次策略、一个目录、
一个提交、一次结果记录”的粒度。
